...
class MapManager:
    def __init__(self, screen, player):
        ...
        self.register_map("world", portals=[
            ...
            NPC("robin", nb_points=2, dialog=["Bonne aventure", "Je m'appelle Robin", "a+"])
        ])
        self.register_map("house", portals=[
            Portal(from_world="house", origin_point="exit_house", target_world="world", teleport_point="exit_house")
        ])
    ...
    def register_map(self, name, portals=[], npcs=[]):
        ...
        #Enregistrer la nouvelle carte chargee
